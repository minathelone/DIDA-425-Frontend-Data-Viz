...
## Example Usage
**Radial Histogram** Check out the [documentation](Documentation/RadialHistogram.md)
```javascript
...
**Butterly Chart** Check out the [documentation](Documentation/ButterflyChart.md)
```javascript
...
**Pictorial Graph** Check out the [documentation](Documentation/PictorialGraph.md)
```javascript
...
**Waterfall Plot** Check out the [documentation](Documentation/WaterfallPlot.md)
```javascript
import { createWaterfallPlot } from 'funky-graphs';
